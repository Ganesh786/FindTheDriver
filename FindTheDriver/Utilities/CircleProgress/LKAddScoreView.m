...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.labelLayer = [[UIView alloc]initWithFrame:CGRectMake(6,20, 84, 28)];
...
//        [self addLabelToView:_pinkLayer textColor:RGBCOLOR(255,135,160)];
        [self addLabelToView:_pinkLayer textColor:[UIColor blackColor]];
...
{
    UILabel* _lb_message = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 84, 14)];
    ...
    UILabel* _lb_sub = [[UILabel alloc]initWithFrame:CGRectMake(0, 42, 84, 14)];
    _lb_sub.tag = 1122;
...
- (void)addLabelWithText:(NSString *)text withColor:(UIColor *)color WithFrame:(CGRect)frame WithFont:(UIFont*)font {
    UILabel* _lb_message = [[UILabel alloc]initWithFrame:frame];
    _lb_message.font = font;
    _lb_message.textColor = color;
    _lb_message.textAlignment = NSTextAlignmentCenter;
    _lb_message.backgroundColor = [UIColor clearColor];
    _lb_message.clipsToBounds = YES;
    _lb_message.text = text;
